...
namespace AllenNeuralDynamics.DelphiController
{
    ...
    public partial class CreateDigitalInputsPayload
    {
        ...
        {
            return AllenNeuralDynamics.DelphiController.DigitalInputs.FromPayload(messageType, GetPayload());
        }
    }
    ...
    public partial class CreateTimestampedDigitalInputsPayload : CreateDigitalInputsPayload
    {
        ...
        {
            return AllenNeuralDynamics.DelphiController.DigitalInputs.FromPayload(timestamp, messageType, GetPayload());
        }
    }
}
