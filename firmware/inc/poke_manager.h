 ...
 */
    ...
    // Constants
    static inline constexpr uint32_t VACUUM_CLOSE_TIME_US = 1e6;// 100'000;
    static inline constexpr uint32_t MIN_POKE_TIME_US = 1e6;
    static inline constexpr uint32_t ODOR_DELIVERY_TIME_US = 1e6; // ??
    static inline constexpr uint32_t ODOR_TRANSITION_TIME_US = 1e6;
    static inline constexpr uint32_t VAC_SETUP_TIME_US = 1e6;
    static inline constexpr uint32_t FINAL_VALVE_ENERGIZED_TIME_US = 1e6;
